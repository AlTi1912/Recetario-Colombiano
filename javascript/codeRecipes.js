    ...
    recetas = {
        "Ajiaco": {
            "Info": {
                ...
                "calorias": "455 por porción",
                "descripcion": "Una sopa tradicional colombiana."
            },
            "Ingredientes": ["Pollo", "Papa Criolla", "Crema de leche", "Mazorca", "Cilantro", "Arroz"],
            "Procedimiento": ["Desmechar el pollo", "Agregar crema de leche a la sopa", "Implementar mazorca y papa criolla"],
            "Imagen": "https://imagenes.elpais.com/resizer/v2/S42RJL45ZNJQDMZYUYP3WQWHW4.jpg?auth=6e8799a19db665a880829f251e8632dc110dabd6a85bc2021524f44cd0bf98cb&width=1960&height=1470&smart=true",
            "color": "#E6F7D4"
        }
    };
    iniciarApp();
